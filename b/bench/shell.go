...
//	m.Flags().StringVar(&workloadId, "wid", "", "Specify a workload identifier")
...
//	key := args[0]
//	fields := args[1:]
//	row, err := globalDB.Read(shellContext, globalProps.Database.CassandraTableName.Value, key, fields)
//	if err != nil {
...
//	fields := args[2:]
//
//	rows, err := globalDB.Scan(shellContext, globalProps.Database.CassandraTableName.Value, key, recordCount, fields)
//	if err != nil {
...
//	}
//
//	if err := globalDB.Insert(shellContext, globalProps.Database.CassandraTableName.Value, key, values); err != nil {
...
//	}
//
//	if err := globalDB.Update(shellContext, globalProps.Database.CassandraTableName.Value, key, values); err != nil {
...
//	key := args[0]
//	if err := globalDB.Delete(shellContext, globalProps.Database.CassandraTableName.Value, key); err != nil {
...
//	if len(args) == 1 {
//		globalProps.Database.CassandraTableName.Value = args[0]
//	}
//	fmt.Printf("Using table %s\n", globalProps.Database.CassandraTableName.Value)
//}
//
//func shellLoop() {
