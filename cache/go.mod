...
require (
	...
	github.com/eko/gocache/store/hazelcast/v4 v4.1.1 // indirect
	github.com/eko/gocache/store/memcache/v4 v4.2.1 // indirect
	github.com/eko/gocache/store/pegasus/v4 v4.2.1 // indirect
	github.com/eko/gocache/store/redis/v4 v4.2.1 // indirect
	github.com/eko/gocache/store/rediscluster/v4 v4.2.0 // indirect
	github.com/eko/gocache/store/ristretto/v4 v4.2.1 // indirect
	github.com/eko/gocache/store/rueidis/v4 v4.1.5 // indirect
